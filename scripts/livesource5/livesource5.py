...
# 创建输出目录
os.makedirs('output/livesource5', exist_ok=True)
...
# 读取黑名单
blacklist_auto = read_blacklist_from_txt('scripts/livesource5/blacklist/blacklist_auto.txt') 
blacklist_manual = read_blacklist_from_txt('scripts/livesource5/blacklist/blacklist_manual.txt') 
...
# 读取频道字典文件
yangshi_dictionary = read_txt_to_array('scripts/livesource5/主频道/CCTV.txt')
weishi_dictionary = read_txt_to_array('scripts/livesource5/主频道/卫视频道.txt')

beijing_dictionary = read_txt_to_array('scripts/livesource5/地方台/北京频道.txt')
shanghai_dictionary = read_txt_to_array('scripts/livesource5/地方台/上海频道.txt')
tianjin_dictionary = read_txt_to_array('scripts/livesource5/地方台/天津频道.txt')
chongqing_dictionary = read_txt_to_array('scripts/livesource5/地方台/重庆频道.txt')
guangdong_dictionary = read_txt_to_array('scripts/livesource5/地方台/广东频道.txt')
jiangsu_dictionary = read_txt_to_array('scripts/livesource5/地方台/江苏频道.txt')
zhejiang_dictionary = read_txt_to_array('scripts/livesource5/地方台/浙江频道.txt')
shandong_dictionary = read_txt_to_array('scripts/livesource5/地方台/山东频道.txt')
henan_dictionary = read_txt_to_array('scripts/livesource5/地方台/河南频道.txt')
sichuan_dictionary = read_txt_to_array('scripts/livesource5/地方台/四川频道.txt')
hebei_dictionary = read_txt_to_array('scripts/livesource5/地方台/河北频道.txt')
hunan_dictionary = read_txt_to_array('scripts/livesource5/地方台/湖南频道.txt')
hubei_dictionary = read_txt_to_array('scripts/livesource5/地方台/湖北频道.txt')
anhui_dictionary = read_txt_to_array('scripts/livesource5/地方台/安徽频道.txt')
fujian_dictionary = read_txt_to_array('scripts/livesource5/地方台/福建频道.txt')
shanxi1_dictionary = read_txt_to_array('scripts/livesource5/地方台/陕西频道.txt')
liaoning_dictionary = read_txt_to_array('scripts/livesource5/地方台/辽宁频道.txt')
jiangxi_dictionary = read_txt_to_array('scripts/livesource5/地方台/江西频道.txt')
heilongjiang_dictionary = read_txt_to_array('scripts/livesource5/地方台/黑龙江频道.txt')
jilin_dictionary = read_txt_to_array('scripts/livesource5/地方台/吉林频道.txt')
shanxi2_dictionary = read_txt_to_array('scripts/livesource5/地方台/山西频道.txt')
guangxi_dictionary = read_txt_to_array('scripts/livesource5/地方台/广西频道.txt')
yunnan_dictionary = read_txt_to_array('scripts/livesource5/地方台/云南频道.txt')
guizhou_dictionary = read_txt_to_array('scripts/livesource5/地方台/贵州频道.txt')
gansu_dictionary = read_txt_to_array('scripts/livesource5/地方台/甘肃频道.txt')
neimenggu_dictionary = read_txt_to_array('scripts/livesource5/地方台/内蒙频道.txt')
xinjiang_dictionary = read_txt_to_array('scripts/livesource5/地方台/新疆频道.txt')
hainan_dictionary = read_txt_to_array('scripts/livesource5/地方台/海南频道.txt')
ningxia_dictionary = read_txt_to_array('scripts/livesource5/地方台/宁夏频道.txt')
qinghai_dictionary = read_txt_to_array('scripts/livesource5/地方台/青海频道.txt')
xizang_dictionary = read_txt_to_array('scripts/livesource5/地方台/西藏频道.txt')

news_dictionary = read_txt_to_array('scripts/livesource5/主频道/新闻频道.txt')
shuzi_dictionary = read_txt_to_array('scripts/livesource5/主频道/数字频道.txt')
dianying_dictionary = read_txt_to_array('scripts/livesource5/主频道/电影频道.txt')
jieshuo_dictionary = read_txt_to_array('scripts/livesource5/主频道/解说频道.txt')
zongyi_dictionary = read_txt_to_array('scripts/livesource5/主频道/综艺频道.txt')
huya_dictionary = read_txt_to_array('scripts/livesource5/主频道/虎牙直播.txt')
douyu_dictionary = read_txt_to_array('scripts/livesource5/主频道/斗鱼直播.txt')
xianggang_dictionary = read_txt_to_array('scripts/livesource5/主频道/香港频道.txt')
aomen_dictionary = read_txt_to_array('scripts/livesource5/主频道/澳门频道.txt')
china_dictionary = read_txt_to_array('scripts/livesource5/主频道/中国频道.txt')
guoji_dictionary = read_txt_to_array('scripts/livesource5/主频道/国际频道.txt')
gangaotai_dictionary = read_txt_to_array('scripts/livesource5/主频道/港澳台.txt')
dianshiju_dictionary = read_txt_to_array('scripts/livesource5/主频道/电视剧.txt')
radio_dictionary = read_txt_to_array('scripts/livesource5/主频道/收音机.txt')
donghuapian_dictionary = read_txt_to_array('scripts/livesource5/主频道/动画片.txt')
jilupian_dictionary = read_txt_to_array('scripts/livesource5/主频道/记录片.txt')
tiyu_dictionary = read_txt_to_array('scripts/livesource5/主频道/体育频道.txt')
tiyusaishi_dictionary = read_txt_to_array('scripts/livesource5/主频道/体育赛事.txt')
youxi_dictionary = read_txt_to_array('scripts/livesource5/主频道/游戏频道.txt')
xiqu_dictionary = read_txt_to_array('scripts/livesource5/主频道/戏曲频道.txt')
yinyue_dictionary = read_txt_to_array('scripts/livesource5/主频道/音乐频道.txt')
chunwan_dictionary = read_txt_to_array('scripts/livesource5/主频道/春晚频道.txt')
zhibozhongguo_dictionary = read_txt_to_array('scripts/livesource5/主频道/直播中国.txt')
...
# 加载频道名称纠错数据
corrections_name = load_corrections_name('scripts/livesource5/corrections_name.txt')
...
# 读取URL列表
urls = read_txt_to_array('scripts/livesource5/urls-daily.txt')
...
whitelist_auto_lines = read_txt_to_array('scripts/livesource5/blacklist/whitelist_auto.txt')
...
if aktv_text:
    ...
    aktv_lines = read_txt_to_array('scripts/livesource5/手工区/AKTV.txt')
...
# 生成体育赛事HTML页面
generate_playlist_html(sorted(set(normalized_tiyusaishi_lines)), 'output/livesource5/sports.html')
...
version = formatted_time + "," + get_random_url('scripts/livesource5/手工区/今日推台.txt')
about = "xiaoranmuze," + get_random_url('scripts/livesource5/手工区/今日推台.txt')

daily_mtv = "今日推荐," + get_random_url('scripts/livesource5/手工区/今日推荐.txt')
daily_mtv1 = "🔥低调," + get_random_url('scripts/livesource5/手工区/今日推荐.txt')
daily_mtv2 = "🔥使用," + get_random_url('scripts/livesource5/手工区/今日推荐.txt')
daily_mtv3 = "🔥禁止," + get_random_url('scripts/livesource5/手工区/今日推荐.txt')
daily_mtv4 = "🔥贩卖," + get_random_url('scripts/livesource5/手工区/今日推荐.txt')

# 处理手工区数据
print(f"处理手工区...")
hubei_lines = hubei_lines + read_txt_to_array('scripts/livesource5/手工区/湖北频道.txt')
guoji_lines = guoji_lines + read_txt_to_array('scripts/livesource5/手工区/国际频道.txt')
gangaotai_lines = gangaotai_lines + read_txt_to_array('scripts/livesource5/手工区/港·澳·台.txt')
donghuapian_lines = donghuapian_lines + read_txt_to_array('scripts/livesource5/手工区/动·画·片.txt')
radio_lines = radio_lines + read_txt_to_array('scripts/livesource5/手工区/收·音·机.txt')
jilupian_lines = jilupian_lines + read_txt_to_array('scripts/livesource5/手工区/记·录·片.txt')
xianggang_lines = xianggang_lines + read_txt_to_array('scripts/livesource5/手工区/香港频道.txt')
aomen_lines = aomen_lines + read_txt_to_array('scripts/livesource5/手工区/澳门频道.txt')
china_lines = china_lines + read_txt_to_array('scripts/livesource5/手工区/中国频道.txt')
...
all_lines_full = ["🌐央视频道,#genre#"] + sort_data(yangshi_dictionary, correct_name_data(corrections_name, yangshi_lines)) + ['\n'] + \
    ...
    ["🕒更新时间,#genre#"] + [version] + [about] + [daily_mtv] + [daily_mtv1] + [daily_mtv2] + [daily_mtv3] + [daily_mtv4] + read_txt_to_array('scripts/livesource5/手工区/about.txt') + ['\n']
...
# 输出文件路径
output_full = "output/livesource5/full.txt"
output_lite = "output/livesource5/lite.txt"
output_custom = "output/livesource5/custom.txt"
output_other = "output/livesource5/other.txt"
...
# 读取频道logo数据
channels_logos = read_txt_to_array('scripts/livesource5/logo.txt')
