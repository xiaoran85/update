...
weishi_dictionary = read_txt_to_array('scripts/livesource3/主频道/卫视.txt')

beijing_dictionary = read_txt_to_array('scripts/livesource3/地方台/北京.txt')
shanghai_dictionary = read_txt_to_array('scripts/livesource3/地方台/上海.txt')
tianjin_dictionary = read_txt_to_array('scripts/livesource3/地方台/天津.txt')
chongqing_dictionary = read_txt_to_array('scripts/livesource3/地方台/重庆.txt')
guangdong_dictionary = read_txt_to_array('scripts/livesource3/地方台/广东.txt')
jiangsu_dictionary = read_txt_to_array('scripts/livesource3/地方台/江苏.txt')
zhejiang_dictionary = read_txt_to_array('scripts/livesource3/地方台/浙江.txt')
shandong_dictionary = read_txt_to_array('scripts/livesource3/地方台/山东.txt')
henan_dictionary = read_txt_to_array('scripts/livesource3/地方台/河南.txt')
sichuan_dictionary = read_txt_to_array('scripts/livesource3/地方台/四川.txt')
hebei_dictionary = read_txt_to_array('scripts/livesource3/地方台/河北.txt')
hunan_dictionary = read_txt_to_array('scripts/livesource3/地方台/湖南.txt')
hubei_dictionary = read_txt_to_array('scripts/livesource3/地方台/湖北.txt')
anhui_dictionary = read_txt_to_array('scripts/livesource3/地方台/安徽.txt')
fujian_dictionary = read_txt_to_array('scripts/livesource3/地方台/福建.txt')
shanxi1_dictionary = read_txt_to_array('scripts/livesource3/地方台/陕西.txt')
liaoning_dictionary = read_txt_to_array('scripts/livesource3/地方台/辽宁.txt')
jiangxi_dictionary = read_txt_to_array('scripts/livesource3/地方台/江西.txt')
heilongjiang_dictionary = read_txt_to_array('scripts/livesource3/地方台/黑龙江.txt')
jilin_dictionary = read_txt_to_array('scripts/livesource3/地方台/吉林.txt')
shanxi2_dictionary = read_txt_to_array('scripts/livesource3/地方台/山西.txt')
guangxi_dictionary = read_txt_to_array('scripts/livesource3/地方台/广西.txt')
yunnan_dictionary = read_txt_to_array('scripts/livesource3/地方台/云南.txt')
guizhou_dictionary = read_txt_to_array('scripts/livesource3/地方台/贵州.txt')
gansu_dictionary = read_txt_to_array('scripts/livesource3/地方台/甘肃.txt')
neimenggu_dictionary = read_txt_to_array('scripts/livesource3/地方台/内蒙.txt')
xinjiang_dictionary = read_txt_to_array('scripts/livesource3/地方台/新疆.txt')
hainan_dictionary = read_txt_to_array('scripts/livesource3/地方台/海南.txt')
ningxia_dictionary = read_txt_to_array('scripts/livesource3/地方台/宁夏.txt')
qinghai_dictionary = read_txt_to_array('scripts/livesource3/地方台/青海.txt')
xizang_dictionary = read_txt_to_array('scripts/livesource3/地方台/西藏.txt')

news_dictionary = read_txt_to_array('scripts/livesource3/主频道/新闻.txt')
shuzi_dictionary = read_txt_to_array('scripts/livesource3/主频道/数字.txt')
dianying_dictionary = read_txt_to_array('scripts/livesource3/主频道/电影.txt')
jieshuo_dictionary = read_txt_to_array('scripts/livesource3/主频道/解说.txt')
zongyi_dictionary = read_txt_to_array('scripts/livesource3/主频道/综艺.txt')
huya_dictionary = read_txt_to_array('scripts/livesource3/主频道/虎牙.txt')
douyu_dictionary = read_txt_to_array('scripts/livesource3/主频道/斗鱼.txt')
xianggang_dictionary = read_txt_to_array('scripts/livesource3/主频道/香港.txt')
aomen_dictionary = read_txt_to_array('scripts/livesource3/主频道/澳门.txt')
china_dictionary = read_txt_to_array('scripts/livesource3/主频道/中国.txt')
guoji_dictionary = read_txt_to_array('scripts/livesource3/主频道/国际.txt')
...
tiyu_dictionary = read_txt_to_array('scripts/livesource3/主频道/体育.txt')
youxi_dictionary = read_txt_to_array('scripts/livesource3/主频道/游戏.txt')
xiqu_dictionary = read_txt_to_array('scripts/livesource3/主频道/戏曲.txt')
yinyue_dictionary = read_txt_to_array('scripts/livesource3/主频道/音乐.txt')
chunwan_dictionary = read_txt_to_array('scripts/livesource3/主频道/春晚.txt')
tyss_dictionary = read_txt_to_array('scripts/livesource3/主频道/体育赛事.txt')
mgss_dictionary = read_txt_to_array('scripts/livesource3/主频道/咪咕赛事.txt')
...
daily_mtv = "💯推荐," + get_random_url('scripts/livesource3/手工区/今日推荐.txt')
...
daily_mtv3 = "⚠️禁止," + get_random_url('scripts/livesource3/手工区/今日推荐.txt')
daily_mtv4 = "🚫贩卖," + get_random_url('scripts/livesource3/手工区/今日推荐.txt')

about_video1 = "https://gitee.com/xiaoran67/update/raw/master/scripts/livesource3/about1080p.mp4"
about_video2 = "https://gitlab.com/xiaoran67/update/-/raw/main/scripts/livesource3/about1080p.mp4"

version = formatted_time + "," + get_random_url('scripts/livesource3/手工区/今日推台.txt')
about = "👨潇然," + get_random_url('scripts/livesource3/手工区/今日推台.txt')
