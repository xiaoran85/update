...
weishi_dictionary = read_txt_to_array('scripts/livesource/主频道/卫视.txt')
...
huya_dictionary = read_txt_to_array('scripts/livesource/主频道/虎牙.txt')
douyu_dictionary = read_txt_to_array('scripts/livesource/主频道/斗鱼.txt')
...
tyss_dictionary = read_txt_to_array('scripts/livesource/主频道/体育赛事.txt')
mgss_dictionary = read_txt_to_array('scripts/livesource/主频道/咪咕赛事.txt')
...
daily_mtv3 = "⚠️禁止," + get_random_url('scripts/livesource/手工区/今日推荐.txt')
daily_mtv4 = "🚫贩卖," + get_random_url('scripts/livesource/手工区/今日推荐.txt')

about_video1 = "https://gitee.com/xiaoran67/update/raw/master/scripts/livesource/about1080p.mp4"
about_video2 = "https://gitlab.com/xiaoran67/update/-/raw/main/scripts/livesource/about1080p.mp4"

version = formatted_time + "," + get_random_url('scripts/livesource/手工区/今日推台.txt')
about = "👨潇然," + get_random_url('scripts/livesource/手工区/今日推台.txt')
