...
#创建输出目录（如果不存在）
os.makedirs('output/custom3/', exist_ok=True)
...
generate_playlist_html(sorted(set(normalized_tyss_lines)), 'output/custom3/sports.html')
...
others_file = "output/custom3/others.txt"

# NEW 将合并后的文本写入文件
new_output_file = "output/custom3/full.txt"
new_output_file_simple = "output/custom3/simple.txt"

# custom定制 将合并后的文本写入文件
new_output_file_custom = "output/custom3/custom.txt"
