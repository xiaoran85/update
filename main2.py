...
#创建输出目录（如果不存在）
os.makedirs('output/custom2/', exist_ok=True)
...
generate_playlist_html(sorted(set(normalized_tyss_lines)), 'output/custom2/sports.html')
...
others_file = "output/custom2/others.txt"

# NEW 将合并后的文本写入文件
new_output_file = "output/custom2/full.txt"
new_output_file_simple = "output/custom2/simple.txt"

# custom定制 将合并后的文本写入文件
new_output_file_custom = "output/custom2/custom.txt"
